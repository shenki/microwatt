//--------------------------------------------------------------------------------
// Auto-generated by Migen (40b1092a05ec) & LiteX (fd33e360fb91) on 2021-02-16 21:47:06
//--------------------------------------------------------------------------------
module liteeth_core(
...
wire builder_csrbank1_sram_writer_ev_status_re;
wire builder_csrbank1_sram_writer_ev_status_r;
wire builder_csrbank1_sram_writer_ev_status_we;
wire builder_csrbank1_sram_writer_ev_status_w;
wire builder_csrbank1_sram_writer_ev_pending_re;
wire builder_csrbank1_sram_writer_ev_pending_r;
wire builder_csrbank1_sram_writer_ev_pending_we;
...
wire builder_csrbank1_sram_reader_ev_status_re;
wire builder_csrbank1_sram_reader_ev_status_r;
wire builder_csrbank1_sram_reader_ev_status_we;
wire builder_csrbank1_sram_reader_ev_status_w;
wire builder_csrbank1_sram_reader_ev_pending_re;
wire builder_csrbank1_sram_reader_ev_pending_r;
wire builder_csrbank1_sram_reader_ev_pending_we;
...
assign main_reader_done0 = main_reader_done_status;
assign main_reader_done1 = main_reader_done_pending;
always @(*) begin
...
assign builder_csrbank1_sram_writer_ev_status_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[4:0] == 2'd3));
assign builder_csrbank1_sram_writer_ev_status_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[4:0] == 2'd3));
assign builder_csrbank1_sram_writer_ev_pending_r = builder_interface1_bank_bus_dat_w[0];
assign builder_csrbank1_sram_writer_ev_pending_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[4:0] == 3'd4));
assign builder_csrbank1_sram_writer_ev_pending_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[4:0] == 3'd4));
...
assign builder_csrbank1_sram_reader_ev_status_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[4:0] == 4'd11));
assign builder_csrbank1_sram_reader_ev_status_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[4:0] == 4'd11));
assign builder_csrbank1_sram_reader_ev_pending_r = builder_interface1_bank_bus_dat_w[0];
assign builder_csrbank1_sram_reader_ev_pending_re = ((builder_csrbank1_sel & builder_interface1_bank_bus_we) & (builder_interface1_bank_bus_adr[4:0] == 4'd12));
assign builder_csrbank1_sram_reader_ev_pending_we = ((builder_csrbank1_sel & (~builder_interface1_bank_bus_we)) & (builder_interface1_bank_bus_adr[4:0] == 4'd12));
...
assign main_reader_status_status = main_reader_done0;
...
assign main_reader_pending_status = main_reader_done1;
...
assign main_reader_done2 = main_reader_enable_storage;
