//--------------------------------------------------------------------------------
// Auto-generated by Migen (0d16e03) & LiteX (f628ff6b) on 2020-05-12 22:00:21
//--------------------------------------------------------------------------------
...
wire [13:0] litedramcore_bus_wishbone_adr;
...
wire csrbank0_half_sys8x_taps0_re;
wire [4:0] csrbank0_half_sys8x_taps0_r;
wire csrbank0_half_sys8x_taps0_we;
wire [4:0] csrbank0_half_sys8x_taps0_w;
wire csrbank0_wlevel_en0_re;
wire csrbank0_wlevel_en0_r;
wire csrbank0_wlevel_en0_we;
wire csrbank0_wlevel_en0_w;
wire csrbank0_dly_sel0_re;
wire [1:0] csrbank0_dly_sel0_r;
wire csrbank0_dly_sel0_we;
wire [1:0] csrbank0_dly_sel0_w;
...
wire [14:0] csrbank1_dfii_pi0_address0_r;
wire csrbank1_dfii_pi0_address0_we;
wire [14:0] csrbank1_dfii_pi0_address0_w;
...
wire [14:0] csrbank1_dfii_pi1_address0_r;
wire csrbank1_dfii_pi1_address0_we;
wire [14:0] csrbank1_dfii_pi1_address0_w;
...
wire [14:0] csrbank1_dfii_pi2_address0_r;
wire csrbank1_dfii_pi2_address0_we;
wire [14:0] csrbank1_dfii_pi2_address0_w;
...
wire [14:0] csrbank1_dfii_pi3_address0_r;
wire csrbank1_dfii_pi3_address0_we;
wire [14:0] csrbank1_dfii_pi3_address0_w;
...
assign litedramcore_dat_w = litedramcore_bus_wishbone_dat_w;
assign litedramcore_bus_wishbone_dat_r = litedramcore_dat_r;
...
always @(*) begin
	...
	case (state)
		...
		default: begin
			if ((litedramcore_bus_wishbone_cyc & litedramcore_bus_wishbone_stb)) begin
				litedramcore_adr <= litedramcore_bus_wishbone_adr;
			end
		end
	endcase
// synthesis translate_off
...
always @(*) begin
	...
	case (state)
		...
		default: begin
			if ((litedramcore_bus_wishbone_cyc & litedramcore_bus_wishbone_stb)) begin
				litedramcore_we <= litedramcore_bus_wishbone_we;
			end
		end
	endcase
// synthesis translate_off
...
assign litedramcore_bus_wishbone_adr = wb_bus_adr;
assign litedramcore_bus_wishbone_dat_w = wb_bus_dat_w;
assign wb_bus_dat_r = litedramcore_bus_wishbone_dat_r;
assign litedramcore_bus_wishbone_sel = wb_bus_sel;
assign litedramcore_bus_wishbone_cyc = wb_bus_cyc;
assign litedramcore_bus_wishbone_stb = wb_bus_stb;
assign wb_bus_ack = litedramcore_bus_wishbone_ack;
assign litedramcore_bus_wishbone_we = wb_bus_we;
assign litedramcore_bus_wishbone_cti = wb_bus_cti;
assign litedramcore_bus_wishbone_bte = wb_bus_bte;
assign wb_bus_err = litedramcore_bus_wishbone_err;
...
always @(*) begin
	csrbank0_sel <= 1'd0;
	csrbank0_sel <= (interface0_bank_bus_adr[13:9] == 1'd0);
...
assign csrbank0_half_sys8x_taps0_r = interface0_bank_bus_dat_w[4:0];
assign csrbank0_half_sys8x_taps0_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 1'd0));
assign csrbank0_half_sys8x_taps0_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 1'd0));
assign csrbank0_wlevel_en0_r = interface0_bank_bus_dat_w[0];
assign csrbank0_wlevel_en0_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 1'd1));
assign csrbank0_wlevel_en0_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 1'd1));
assign a7ddrphy_wlevel_strobe_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_wlevel_strobe_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 2'd2));
assign a7ddrphy_wlevel_strobe_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 2'd2));
assign a7ddrphy_cdly_rst_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_cdly_rst_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 2'd3));
assign a7ddrphy_cdly_rst_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 2'd3));
assign a7ddrphy_cdly_inc_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_cdly_inc_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 3'd4));
assign a7ddrphy_cdly_inc_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 3'd4));
assign csrbank0_dly_sel0_r = interface0_bank_bus_dat_w[1:0];
assign csrbank0_dly_sel0_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 3'd5));
assign csrbank0_dly_sel0_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 3'd5));
assign a7ddrphy_rdly_dq_rst_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_rdly_dq_rst_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 3'd6));
assign a7ddrphy_rdly_dq_rst_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 3'd6));
assign a7ddrphy_rdly_dq_inc_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_rdly_dq_inc_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 3'd7));
assign a7ddrphy_rdly_dq_inc_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 3'd7));
assign a7ddrphy_rdly_dq_bitslip_rst_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_rdly_dq_bitslip_rst_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 4'd8));
assign a7ddrphy_rdly_dq_bitslip_rst_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 4'd8));
assign a7ddrphy_rdly_dq_bitslip_r = interface0_bank_bus_dat_w[0];
assign a7ddrphy_rdly_dq_bitslip_re = ((csrbank0_sel & interface0_bank_bus_we) & (interface0_bank_bus_adr[4:1] == 4'd9));
assign a7ddrphy_rdly_dq_bitslip_we = ((csrbank0_sel & (~interface0_bank_bus_we)) & (interface0_bank_bus_adr[4:1] == 4'd9));
assign csrbank0_half_sys8x_taps0_w = a7ddrphy_half_sys8x_taps_storage[4:0];
assign csrbank0_wlevel_en0_w = a7ddrphy_wlevel_en_storage;
assign csrbank0_dly_sel0_w = a7ddrphy_dly_sel_storage[1:0];
...
assign csrbank1_dfii_pi0_address0_r = interface1_bank_bus_dat_w[14:0];
...
assign csrbank1_dfii_pi1_address0_r = interface1_bank_bus_dat_w[14:0];
...
assign csrbank1_dfii_pi2_address0_r = interface1_bank_bus_dat_w[14:0];
...
assign csrbank1_dfii_pi3_address0_r = interface1_bank_bus_dat_w[14:0];
...
assign csrbank1_dfii_pi0_address0_w = litedramcore_phaseinjector0_address_storage[14:0];
...
assign csrbank1_dfii_pi1_address0_w = litedramcore_phaseinjector1_address_storage[14:0];
...
assign csrbank1_dfii_pi2_address0_w = litedramcore_phaseinjector2_address_storage[14:0];
...
assign csrbank1_dfii_pi3_address0_w = litedramcore_phaseinjector3_address_storage[14:0];
...
always @(posedge sys_clk) begin
	...
	if (csrbank0_sel) begin
		case (interface0_bank_bus_adr[4:1])
			1'd0: begin
				interface0_bank_bus_dat_r <= csrbank0_half_sys8x_taps0_w;
			end
			1'd1: begin
				interface0_bank_bus_dat_r <= csrbank0_wlevel_en0_w;
			end
			2'd2: begin
				interface0_bank_bus_dat_r <= a7ddrphy_wlevel_strobe_w;
			end
			2'd3: begin
				interface0_bank_bus_dat_r <= a7ddrphy_cdly_rst_w;
			end
			3'd4: begin
				interface0_bank_bus_dat_r <= a7ddrphy_cdly_inc_w;
			end
			3'd5: begin
				interface0_bank_bus_dat_r <= csrbank0_dly_sel0_w;
			end
			3'd6: begin
				interface0_bank_bus_dat_r <= a7ddrphy_rdly_dq_rst_w;
			end
			3'd7: begin
				interface0_bank_bus_dat_r <= a7ddrphy_rdly_dq_inc_w;
			end
			4'd8: begin
				interface0_bank_bus_dat_r <= a7ddrphy_rdly_dq_bitslip_rst_w;
			end
			4'd9: begin
				interface0_bank_bus_dat_r <= a7ddrphy_rdly_dq_bitslip_w;
			end
		endcase
	end
	if (csrbank0_half_sys8x_taps0_re) begin
		a7ddrphy_half_sys8x_taps_storage[4:0] <= csrbank0_half_sys8x_taps0_r;
	end
	a7ddrphy_half_sys8x_taps_re <= csrbank0_half_sys8x_taps0_re;
	if (csrbank0_wlevel_en0_re) begin
		a7ddrphy_wlevel_en_storage <= csrbank0_wlevel_en0_r;
	end
	a7ddrphy_wlevel_en_re <= csrbank0_wlevel_en0_re;
	if (csrbank0_dly_sel0_re) begin
		a7ddrphy_dly_sel_storage[1:0] <= csrbank0_dly_sel0_r;
	end
	a7ddrphy_dly_sel_re <= csrbank0_dly_sel0_re;
	...
	if (csrbank1_dfii_pi0_address0_re) begin
		litedramcore_phaseinjector0_address_storage[14:0] <= csrbank1_dfii_pi0_address0_r;
	end
	...
	if (csrbank1_dfii_pi1_address0_re) begin
		litedramcore_phaseinjector1_address_storage[14:0] <= csrbank1_dfii_pi1_address0_r;
	end
	...
	if (csrbank1_dfii_pi2_address0_re) begin
		litedramcore_phaseinjector2_address_storage[14:0] <= csrbank1_dfii_pi2_address0_r;
	end
	...
	if (csrbank1_dfii_pi3_address0_re) begin
		litedramcore_phaseinjector3_address_storage[14:0] <= csrbank1_dfii_pi3_address0_r;
	end
